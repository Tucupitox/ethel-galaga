...
class MenuButton:
    def __init__(self, text, x, y, width, height, is_circle=False):
        ...
        self.base_color = (75, 0, 130)  # Morado
        self.hover_color = (106, 0, 185) 
        self.border_color = (218, 165, 32) # Dorado
        self.hover_border_color = (255, 215, 0)
    ...
    def draw(self, surface, font):
        ...
        rad = self.rect.width // 2 if self.is_circle else 8
        
        pygame.draw.rect(surface, color, self.rect, border_radius=rad)
        pygame.draw.rect(surface, b_color, self.rect, width=4, border_radius=rad)
...
def draw_text_with_shadow(surface, text, font, color=(255, 255, 255), x=0, y=0):
    ...
    surface.blit(text_shadow, (x + 3, y + 3))
